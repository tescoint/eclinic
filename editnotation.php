...
if(!empty($edata['prescription'])){
  header("location:viewnotation.php?p=$_GET[p]");
}
?>
<!DOCTYPE html>
<html>
<head>
	<title>E-CLINIC || Edit Notation</title>
	...
	<div class="page-content"> 
		<div class="content">  
			...
			<!-- BEGIN PlACE PAGE CONTENT HERE -->
			 <div class="row">
			 <form name="editnotation" id="editnotation">
            <div class="col-md-12">
        ...
        <div class="col-md-12">
              <div class="grid simple">
                ...
                <div class="grid-body no-border">
                    ...
                    <br>
                    <textarea name="notation" id="text-editor" placeholder="Enter text ..." class="form-control textarea1" rows="10"><?php echo $edata['notation']; ?></textarea>
                </div>
              </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
              <div class="grid simple">
                ...
                <div class="grid-body no-border">
                    ...
                    <br>
                    <textarea name="prescription" id="text-editor" placeholder="Enter text ..." class="form-control textarea2" rows="10"><?php echo $edata['prescription'];?></textarea>
                    <br>
                    <input type="hidden" name="id" id="id" value="<?php echo $_GET['id'];?>">
                    <button class="btn btn-primary btn-cons" style="float:right">UPDATE</button>
                 </div>
              </div>
        </div>
      </div>	  
